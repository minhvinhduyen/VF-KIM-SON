  ...
  if (activeTab !== 'overview') {
    ...
    return (
      <div className="flex flex-col min-h-screen bg-gray-50">
        <div className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-30 px-3 py-2 flex items-center justify-between">
          <button
          ...
          <span className="text-sm font-bold bg-blue-50 text-brand-blue px-3 py-1.5 rounded-lg truncate max-w-[60%] text-center">{activeFacilityName}</span>
        </div>
